...
t_sparse = @elapsed sparsemodel = OMGP.SparseXGPC(X,y,Stochastic=false,Autotuning=true,ϵ=1e-30,VerboseLevel=3,m=N_indpoints,noise=noise,kernel=kernel)
metrics,savelog = OMGP.getLog(sparsemodel)
