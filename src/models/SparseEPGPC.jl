mutable struct SparseEPGPC <: SparseModel
    ...
    function SparseEPGPC(X::AbstractArray,y::AbstractArray;Stochastic::Bool=false,AdaptiveLearningRate::Bool=true,
            ...
            this = new();
            this.ModelType = EPGPC;
            this.Name = "Expecation Propagation Sparse Gaussian Process Classifier";
