...
mutable struct SparseSoftMaxMultiClass{T<:Real} <: MultiClassGPModel{T}
    @commonfields
    @functionfields
    @multiclassfields
    ...
    function SparseSoftMaxMultiClass(X::AbstractArray{T},y::AbstractArray;Stochastic::Bool=false,KStochastic::Bool=false,nClassesUsed::Int=0,AdaptiveLearningRate::Bool=true,
