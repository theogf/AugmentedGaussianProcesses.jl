...
mutable struct LogisticSoftMaxMultiClass{T} <: MultiClassGPModel{T}
    @commonfields
    @functionfields
    @multiclassfields
    ...
    function LogisticSoftMaxMultiClass(X::AbstractArray{T},y::AbstractArray;Autotuning::Bool=false,optimizer::Real=0.01,nEpochs::Integer = 200, KStochastic::Bool = false, nClassesUsed::Int=0,
            ...
            this.L = [LowerTriangular(Diagonal(one(T)*I,this.m)) for _ in 1:this.K]
