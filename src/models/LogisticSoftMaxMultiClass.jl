...
mutable struct LogisticSoftMaxMultiClass{T} <: MultiClassGPModel{T}
    ...
    function LogisticSoftMaxMultiClass(X::AbstractArray{T},y::AbstractArray;Autotuning::Bool=false,optimizer=0.01,nEpochs::Integer = 200, KStochastic::Bool = false, nClassesUsed::Int=0,
