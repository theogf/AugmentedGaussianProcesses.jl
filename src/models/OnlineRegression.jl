...
mutable struct OnlineGPRegression <: SparseModel
    @commonfields
    @functionfields
    @stochasticfields
    @kernelfields
    ...
    function OnlineGPRegression(X::AbstractArray,y::AbstractArray;Stochastic::Bool=false,AdaptiveLearningRate::Bool=true,
